...
public class Device {
    ...
    public void loadClassifire(String filename) {
        this.processingunit.loadClassifier(filename);
    }

    public void saveClassifire(String filename) {
        this.processingunit.saveClassifier(filename);
    }
